(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["default~admin-admin-module~store-store-module"],{

/***/ "../AngularTypeScript/node_modules/@angular/common/fesm5/http.js":
/*!***********************************************************************!*\
  !*** ../AngularTypeScript/node_modules/@angular/common/fesm5/http.js ***!
  \***********************************************************************/
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "../AngularTypeScript/node_modules/rxjs/_esm5/index.js");
...
/* harmony import */ var _angular_common__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/common */ "../AngularTypeScript/node_modules/@angular/common/fesm5/common.js");
/**
...
/***/ "../AngularTypeScript/node_modules/@angular/forms/fesm5/forms.js":
/*!***********************************************************************!*\
  !*** ../AngularTypeScript/node_modules/@angular/forms/fesm5/forms.js ***!
  \***********************************************************************/
...
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "../AngularTypeScript/node_modules/rxjs/_esm5/index.js");
/* harmony import */ var rxjs_operators__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! rxjs/operators */ "../AngularTypeScript/node_modules/rxjs/_esm5/operators/index.js");
/* harmony import */ var _angular_platform_browser__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/platform-browser */ "../AngularTypeScript/node_modules/@angular/platform-browser/fesm5/platform-browser.js");
/**
 * @license Angular v7.2.15
 * (c) 2010-2019 Google LLC. https://angular.io/
 * License: MIT
...
var ProductRepository = /** @class */ (function () {
    ...
    ProductRepository.prototype.getProducts = function (categoryId) {
        if (categoryId === void 0) { categoryId = null; }
        return this.products
            .filter(function (p) { return categoryId == null || categoryId == p.categoryId; });
    };
        ...
        if (product.id == null || product.id == "") {
            ...
            this.dataSource.updateProduct(product)
                ...
                _this.products.splice(_this.products
                    .findIndex(function (p) { return p.id == product.id; }), 1, p);
            });
        }
    };
    ...
    ProductRepository.prototype.saveCategory = function (category) {
        var _this = this;
        if (category.id == null || category.id == "") {
            this.dataSource.saveCategory(category)
                .subscribe(function (p) { return _this.categories.push(p); });
        }
        else {
            this.dataSource.updateCategory(category)
                .subscribe(function (c) {
                var index = _this.categories.findIndex(function (c) { return c.id == category.id; });
                _this.categories.splice(index, 1, c);
            });
        }
    };
    ...
    ProductRepository.prototype.getCategory = function (categoryId) {
        return this.categories.find(function (c) { return c.id == categoryId; });
    };
    ProductRepository.prototype.deleteCategory = function (id) {
        var _this = this;
...
var RestDataSource = /** @class */ (function () {
    ...
    RestDataSource.prototype.getCategories = function () {
        return this.http.get(this.baseUrl + "api/cats"); //api/categories doesn't work with dot net
    };
    RestDataSource.prototype.saveProduct = function (product) {
        return this.http.post(this.baseUrl + "api/products", product, this.getOptions());
    };
    RestDataSource.prototype.updateProduct = function (product) {
        return this.http.put(this.baseUrl + "api/products/" + product.id, product, this.getOptions());
    };
    RestDataSource.prototype.deleteProduct = function (id) {
        return this.http.delete(this.baseUrl + "api/products/" + id, this.getOptions());
    };
    RestDataSource.prototype.getOrders = function () {
        return this.http.get(this.baseUrl + "api/orders", this.getOptions());
    };
    ...
    RestDataSource.prototype.deleteOrder = function (id) {
        return this.http.delete(this.baseUrl + "api/orders/" + id, this.getOptions());
    };
    RestDataSource.prototype.updateOrder = function (order) {
        return this.http.put(this.baseUrl + "api/orders/" + order.id, order, this.getOptions());
    };
    RestDataSource.prototype.saveCategory = function (category) {
        return this.http.post(this.baseUrl + "api/cats", category, this.getOptions());
    };
    RestDataSource.prototype.updateCategory = function (category) {
        return this.http.put(this.baseUrl + "api/cats/" + category.id, category, this.getOptions());
    };
    RestDataSource.prototype.deleteCategory = function (id) {
        return this.http.delete(this.baseUrl + "api/cats/" + id, this.getOptions());
    };
...
//# sourceMappingURL=default~admin-admin-module~store-store-module.js.map